...
func writeUsage(writer io.Writer) {
	fmt.Fprintln(writer, "Pitlord enforces repository architecture policy and provides deterministic diagnosis.")
	fmt.Fprintln(writer)
	fmt.Fprintln(writer, "Primary workflow:")
	fmt.Fprintln(writer, "  pitlord check --repo <root> --policy <pitlord.json> [--baseline <baseline.json>]")
	fmt.Fprintln(writer, "  pitlord scan --repo <root> [--analyzers architecture,semantic,clippy] [--format text|json]")
	...
	fmt.Fprintln(writer)
	fmt.Fprintln(writer, "Policy and CI:")
	...
	fmt.Fprintln(writer, "  pitlord docs --repo <root> --changed-from <revision> [--ddocs-root <path>]")
	fmt.Fprintln(writer)
	fmt.Fprintln(writer, "Evidence and development:")
	fmt.Fprintln(writer, "  pitlord calibrate --repo <corpus> --reference <reference.json> [--format text|json]")
