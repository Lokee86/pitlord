...
- a calibrated advisory language-neutral `impact-blast-radius` detector that reports unusually broad transitive dependent surfaces only when they expand through at least three substantial independent first-hop branches and no single branch owns more than 80% of the closure;
