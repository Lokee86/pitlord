...
| `internal/scan` | Policy-free generalized finding contract, source-role peer classification, dependency-pressure boundary/role judgment, dependency-knot SCC projection/judgment, scope normalization, deterministic ordering, and scan result assembly | [Architecture](../ARCHITECTURE.md), [Current limitations](../limits/current-limitations.md) |
...
| Policy-free generalized scan peer classification, dependency-pressure judgment, dependency-knot SCC judgment, and result assembly | [Architecture](../ARCHITECTURE.md), [Current limitations](../limits/current-limitations.md) |
