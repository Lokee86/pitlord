...
| Policy-free generalized scan peer classification, dependency-pressure judgment, dependency-knot static-relation/semantic-region SCC judgment, and result assembly | [Architecture](../ARCHITECTURE.md), [Current limitations](../limits/current-limitations.md) |
