...
| Policy-free generalized scan peer classification, dependency-pressure judgment, dependency-knot static-relation/semantic-region SCC judgment, dependency-depth dominant acyclic behavioral-corridor judgment, boundary-bypass file/region intermediary judgment, boundary/cohesion semantic-region judgment, hub/bottleneck behavioral-waist judgment, impact/blast-radius direct-exposure and independent-transitive-impact judgment, and result assembly | [Architecture](../ARCHITECTURE.md), [Current limitations](../limits/current-limitations.md) |
