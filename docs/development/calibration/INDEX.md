...
- [Impact/blast-radius baseline](impact-blast-radius.md) — Transitive-impact audit and tuning record: 74 untouched false positives from inherited closure, tuned to 81 TN / 0 FP with independent first-hop branch evidence; synthetic topology supplies the current positive control.
