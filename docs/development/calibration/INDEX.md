...
- [Calibration reference set](REFERENCE-SET.md) — Human index for the 165 machine-readable scoring projections stored under `testdata/calibration/`: ten architecture projections for each of the 16 frozen corpora, two diff-pinned Space Rocks intermediary-bypass mutation positives, and three strict semantic analyzer references.
