...
- [Calibration references](references/INDEX.md) — The 96 machine-readable detector scoring projections for the 16 frozen corpora across dependency pressure, dependency knots, dependency depth, boundary/cohesion, hub/bottleneck, and impact/blast-radius analysis.
