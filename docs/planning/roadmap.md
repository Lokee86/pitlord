...
1. Continue the policy-free generalized architecture scan over Arcana structural evidence: dependency pressure, dependency knots, boundary/cohesion, and hub/bottleneck are implemented; impact/blast-radius analysis remains.
