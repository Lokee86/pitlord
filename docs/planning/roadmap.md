...
1. Add required real-world positive calibration coverage for boundary/cohesion before making recall or guard-readiness claims for that detector family.
