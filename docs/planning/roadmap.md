...
1. Add required real-world positive calibration coverage for boundary/cohesion and file/region boundary-bypass before making recall or guard-readiness claims for those detector families.
